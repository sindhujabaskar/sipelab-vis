...
grating_angles_array = [0, 1, 2, 3, 4, 5, 7, 9]
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\dev\\PsychoPy\\Gratings_vis_stim_devJG_v0.2\\Gratings_vis_stim_devJG_v0.2_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=128.0, method='sequential', 
    ...
    for thisTrial in trials:
        ...
        while continueRoutine and routineTimer.getTime() < 5.0:
            ...
            if stim_grayScreen.status == NOT_STARTED and frameN >= 120:
                # keep track of start time/frame for later
    ...
    # completed 128.0 repeats of 'trials'
